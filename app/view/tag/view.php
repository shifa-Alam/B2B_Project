        ...
        <div class="row">
			<div class="col-xs-12">
				<div class="page-title-box">
                    <h4 class="page-title">Tag Table </h4>
							...
							<table id="tech-companies-1" class="table  table-striped">
								<thead>
									<tr>
										...
										<th data-priority="3">Tag Id</th>
										<th data-priority="1">Tag Name</th>
										...
										if($db_return){
											...
											while($data=$db_return->fetch_assoc()){?>
												<tr>
													...
													<td>
														<a href="index.php?c=tag&a=edit&<?php echo $data['id'];?>"><i class="fa fa-pencil-square-o fa-2x"></i></a> 
